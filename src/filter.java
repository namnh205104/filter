		...
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
				if (i == 0 && j == 0) {
					...
					gx.red = old_pixel[i][j - 1].red * -2 + old_pixel[i][j + 1].red * 2 - old_pixel[i + 1][j - 1].red
							+ old_pixel[i + 1][j + 1].red;
					gx.green = old_pixel[i][j - 1].green * -2 + old_pixel[i][j + 1].green * 2 - old_pixel[i + 1][j - 1].green
							+ old_pixel[i + 1][j + 1].green;
					gx.blue = old_pixel[i][j - 1].blue * -2 + old_pixel[i][j + 1].blue * 2 - old_pixel[i + 1][j - 1].blue
							+ old_pixel[i + 1][j + 1].blue;
					gy.red = old_pixel[i + 1][j - 1].red + old_pixel[i + 1][j].red * 2 + old_pixel[i + 1][j + 1].red;
					gy.green = old_pixel[i + 1][j - 1].green + old_pixel[i + 1][j].green * 2 + old_pixel[i + 1][j + 1].green;
					gy.blue = old_pixel[i + 1][j - 1].blue + old_pixel[i + 1][j].blue * 2 + old_pixel[i + 1][j + 1].blue;
				} else if (i == height - 1 && j < width - 1) {
					gx.red = -old_pixel[i - 1][j - 1].red + old_pixel[i - 1][j + 1].red - old_pixel[i][j - 1].red * 2
							+ old_pixel[i][j + 1].red * 2;
					gx.green = -old_pixel[i - 1][j - 1].green + old_pixel[i - 1][j + 1].green - old_pixel[i][j - 1].green * 2
							+ old_pixel[i][j + 1].green * 2;
					gx.blue = -old_pixel[i - 1][j - 1].blue + old_pixel[i - 1][j + 1].blue - old_pixel[i][j - 1].blue * 2
					...
					gx.red = old_pixel[i - 1][j + 1].red + old_pixel[i][j + 1].red * 2 + old_pixel[i + 1][j + 1].red;
					gx.green = old_pixel[i - 1][j + 1].green + old_pixel[i][j + 1].green * 2 + old_pixel[i + 1][j + 1].green;
					gx.blue = old_pixel[i - 1][j + 1].blue + old_pixel[i][j + 1].blue * 2 + old_pixel[i + 1][j + 1].blue;
					gy.red = old_pixel[i - 1][j].red * -2 - old_pixel[i - 1][j + 1].red + old_pixel[i + 1][j].red * 2
							+ old_pixel[i + 1][j + 1].red;
					gy.green = old_pixel[i - 1][j].green * -2 - old_pixel[i - 1][j + 1].green + old_pixel[i + 1][j].green * 2
							+ old_pixel[i + 1][j + 1].green;
					gy.blue = old_pixel[i - 1][j].blue * -2 - old_pixel[i - 1][j + 1].blue + old_pixel[i + 1][j].blue * 2
							+ old_pixel[i + 1][j + 1].blue;
					...
					gy.green = -old_pixel[i - 1][j - 1].green - old_pixel[i - 1][j].green * 2 + old_pixel[i + 1][j - 1].green
							+ old_pixel[i + 1][j].green * 2;
					gy.blue = -old_pixel[i - 1][j - 1].blue - old_pixel[i - 1][j].blue * 2 + old_pixel[i + 1][j - 1].blue
							+ old_pixel[i + 1][j].blue * 2;
				} else {
					gx.red = -old_pixel[i - 1][j - 1].red + old_pixel[i - 1][j + 1].red - old_pixel[i][j - 1].red * 2
							+ old_pixel[i][j + 1].red * 2 - old_pixel[i + 1][j - 1].red + old_pixel[i + 1][j + 1].red;
					gx.green = -old_pixel[i - 1][j - 1].green + old_pixel[i - 1][j + 1].green - old_pixel[i][j - 1].green * 2
							+ old_pixel[i][j + 1].green * 2 - old_pixel[i + 1][j - 1].green + old_pixel[i + 1][j + 1].green;
					gx.blue = -old_pixel[i - 1][j - 1].blue + old_pixel[i - 1][j + 1].blue - old_pixel[i][j - 1].blue * 2
							+ old_pixel[i][j + 1].blue * 2 - old_pixel[i + 1][j - 1].blue + old_pixel[i + 1][j + 1].blue;
					gy.red = -old_pixel[i - 1][j - 1].red - old_pixel[i - 1][j].red * 2 - old_pixel[i - 1][j + 1].red
							+ old_pixel[i + 1][j - 1].red + old_pixel[i + 1][j].red * 2 + old_pixel[i + 1][j + 1].red;
					gy.green = -old_pixel[i - 1][j - 1].green - old_pixel[i - 1][j].green * 2 - old_pixel[i - 1][j + 1].green
							+ old_pixel[i + 1][j - 1].green + old_pixel[i + 1][j].green * 2 + old_pixel[i + 1][j + 1].green;
					gy.blue = -old_pixel[i - 1][j - 1].blue - old_pixel[i - 1][j].blue * 2 - old_pixel[i - 1][j + 1].blue
							+ old_pixel[i + 1][j - 1].blue * +old_pixel[i + 1][j].blue * 2 + old_pixel[i + 1][j + 1].blue;
				}
